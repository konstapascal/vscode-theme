...
function help() {
	console.log(`
	${chalk.greenBright('vsc-theme [command] <options>')}
	  ...
	  ${chalk.blueBright('remove')} .............. remove a theme from the list of the available ones
	  
	  ${chalk.blueBright('help')} ................ show help menu for all commands
	  ${chalk.blueBright('version')} ............. show the installed version of vsc-theme

	  
	  ${chalk.redBright.bold('PS: Te iubesc muuult, muult, Katy! <3')}
	`);
}
